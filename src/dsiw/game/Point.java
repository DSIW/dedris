...
public class Point {
	 ...
	 * @param level Leel
	 * @param figuresInGame Anzahl der Figuren, die dem Spiel hinzugefügt worden sind.
	 */
	public void calc(int fullRows, int level, int figuresInGame) {
		aktPoints = (MIN_POINTS + fullRows * POINTS_PER_LEVEL + figuresInGame * POINTS_PER_FIGURE);
	}
