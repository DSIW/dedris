...
import dedris.highscore.HighscoreTable;
...
public class MyMenu extends JMenuBar
{
    ...
    highscore.addActionListener(new ActionListener()
    {
      public void actionPerformed (ActionEvent e)
      {
        try {
          ...
          highscore.setEnabled(false);
          highscore
              .setToolTipText("Highscore-Datei enthält noch keine Einträge.");
        }
      }
    });
    ret.add(highscore);
  ...
  public void toPause ()
  {
    if (!g.isGameOver() && !g.isNewGame()) {
      ...
      stopGame.setEnabled(false);
      stopGame
          .setToolTipText("Spiel kann erst wieder gestoppt werden, wenn die Pause deaktiviert ist.");
    }
  }
