...
import dedris.exception.NoHighscoreInFileException;
import dedris.frame.Game;
import dedris.frame.MyNoGameJFrame;

/**
 * Die Highscore-Tabelle wird aus den Highscores erstellt. Spaltenüberschriften,
 * -laengen werden hinzugefügt.
 * 
 * @author DSIW
 * 
 */
public class HighscoreTable extends MyNoGameJFrame
{
  ...
  private final String[]    columnsNames     = { "Place", "Gamer", "Level",
      "Points"                              };
   ...
   * 
   * @param hs
   *          Highscore-Liste wird in ein Array umgewandelt.
   */
  ...
  public HighscoreTable(Highscore hs, Game g, boolean setVisible, boolean setPos)
  {
    ...
    for (int i = 0; i < columnsNames.length; i++) {
      ...
      // lengthColumns[getIndexOfGamerColumn()] =
      // 450-lengthColumns[0]-lengthColumns[2]-lengthColumns[3];
